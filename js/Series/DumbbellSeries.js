...
var AreaSeries = seriesTypes.area, AreaRangeSeries = seriesTypes.arearange, ColumnRangeSeries = seriesTypes.columnrange;
...
var areaRangeProto = AreaRangeSeries.prototype, columnRangeProto = ColumnRangeSeries.prototype, TrackerMixin = H.TrackerMixin; // Interaction
var DumbbellSeries = /** @class */ (function (_super) {
    ...
    DumbbellSeries.defaultOptions = merge(AreaSeries.defaultOptions, AreaRangeSeries.defaultOptions, {
        /** @ignore-option */
        trackByArea: false,
        /** @ignore-option */
        fillColor: 'none',
...
var _a = areaRangeProto.pointClass.prototype, isValid = _a.isValid, destroyElements = _a.destroyElements;
